...
class DeviceInfo(object):
    ...
    def __init__(self, model_name, model_num, software_version, serial_num, power_mode):
    ...
    def __repr__(self):
        return ('<DeviceInfo: %s-%s, SW v%s, Ser# %s, Pow %s>' %
                (self.model_name, self.model_num,
                 self.software_version, self.serial_num, self.power_mode))
